							...
							<View style={styles.cardContainer} key={key}>
								<Card style={styles.card}>
									<CardItem header bordered style={styles.cardTitle}>
										...
										<H1> {moment(journey.startTime).format("hh:mm a")} - {moment(journey.endTime).format("hh:mm a")} </H1>
										<Right>
											<Icon
												name="arrow-forward"
												size={40}
									...
									<View>
										<Content>
											<CardItem>
												...
												<Text style={styles.cardHeaders}>Service Number: {Math.floor(Math.random() * 1000000)}</Text>
											</CardItem>
											<CardItem>
												<Icon name="my-location" size={20} color="#bcbcbc" />
												<Text style={styles.cardHeaders}>{`${journey.fromStreet}, ${journey.fromCity}`}</Text>
											</CardItem>
										...
										<CardItem>
											...
											<Text style={styles.cardHeaders}>{`${journey.toStreet}, ${journey.toCity}`}</Text>
										</CardItem>
									</View>
								</Card>
							</View>
